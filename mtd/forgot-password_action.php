...
if (isset($_POST['forgot_password'])) {
    ...
    // Check if the email exists in the MTD table
    $emailCheckQuery = "SELECT * FROM mtd WHERE mtd_email = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        // Update the MTD table with the verification code
        $updateQuery = "UPDATE mtd SET code = ? WHERE mtd_email = ?";
        ...
        if ($stmt->execute()) {
            ...
            try {
                ...
                // Email content
                $mail->isHTML(true);
                $mail->Subject = 'MTD Admin Verification Code';
                $mail->Body = "
                    <html>
                    <head>
                        <style>
