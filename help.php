...
<body class="overlay-scrollbar">
    ...
    <div class="topnavbar animated fadeIn">
        ...
        <ul class="topnavbar-nav">
            ...
            <a href="index.php"><img src="assets/img/new.png" alt="TFMS logo" class="logo logo-light" style="width: 220px; height: auto"></a>            
            </li>
        </ul>
        <!-- end topnav left -->
        <!-- topnav right -->
        <ul class="topnavbar-nav topnav-right">
            <li class="topnav-item">
                <div class="mydropdown">
                    <p class="mt-3 mr-4">
                        <a href="user/login.php"><span class="btn btn-lg btn-danger" data-toggle="modal" data-target="#userLogdin">Log In <i class="fas fa-sign-in-alt" style="font-size: 1rem;"></i></span></a>
                    </p>
                </div>
            </li>
        </ul>
