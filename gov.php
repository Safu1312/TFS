...
<head>
    <title>Government Official Log in</title>
            ...
            <ul class="topnavbar-nav topnav-right">
                <li class="topnav-item">
                    <div class="mydropdown">
                        <p class="mt-3 mr-4">
                            <a href="user/login.php"><span class="btn btn-lg btn-danger" data-toggle="modal" data-target="#userLogdin">Log in as driver <i class="fas fa-sign-in-alt" style="font-size: 1rem;"></i></span></a>
                        </p>
                    </div>
                </li>
            </ul>
