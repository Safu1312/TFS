...
<head>
    <title>Traffic Police Officer | Login</title>
    <!--Meta tags start-->
    <meta charset="UTF-8">
				...
				<?php } ?>
                        <form class="form-signin" action="login_action" method="POST">
                            <div class="form-label-group">
                                <input type="text" id="inputID" name="police_id" class="form-control" placeholder="Enter Your Police ID" >
                            </div>
                            <div class="form-label-group">
                                <input type="password" id="inputPassword" name="officer_password" class="form-control" placeholder="Enter Your Password">
                            </div>
                            <button class="btn btn-lg btn-block text-uppercase" type="submit">Log in</button>
                            <hr class="my-4">
                            <h6 style="text-align: center; text-decoration: none;"><span><a href="forgot-password.php"><i class="fas fa-unlock-alt"></i> Forget Password?</a></span> <span class="ml-2 homelink"><a href="../gov.php"><i class="fas fa-home"></i> Return to Login Page</a></span></h6>
                        </form>
                    </div>
                </div>
            </div>
