...
<head>
    <title>Traffic Fine Management System SL</title>

    <!--Meta tags start-->
    <meta charset="UTF-8">
    <meta name="description" content="Traffic Fine Management System Sri Lanka">
    <meta name="keywords" content="Traffic, Fine, System, Sri Lanka">
    <meta name="author" content="Safwan Saleem">
    <meta name="viewport" content="width=device-width, height=device-height, initial-scale=1.0, user-scalable=0, minimum-scale=1.0, maximum-scale=1.0">
    <!--Meta tags end-->

    <!--Favicon start-->
    <link rel="icon" type="image/png" href="assets/img/tablogo.png">
    <!--Favicon end-->
    ...
    <div class="topnavbar animated fadeIn">
        ...
        <ul class="topnavbar-nav">
            <li class="topnav-item">
                <a href="index.php"><img src="assets/img/new.png" alt="STFMS logo" class="logo logo-light" style="width: 220px; height: auto"></a>            
            </li>
        </ul>
        <!-- end topnav left -->
        <!-- topnav right -->
        <ul class="topnavbar-nav topnav-right">
            <li class="topnav-item">
                <div class="mydropdown">
                    <p class="mt-3 mr-4">
                        <a href="user/login.php"><span class="btn btn-lg btn-danger" data-toggle="modal" data-target="#userLogdin">Driver Log In <i class="fas fa-sign-in-alt" style="font-size: 1rem;"></i></span></a>
                    </p>
                </div>
            </li>
        </ul>
            ...
            <div class="container animated fadeIn">
                <div class="row">
                    <div class="footer-col">
                        <h4>Inquiry via Hotline</h4>
                        <ul>
                            <li><a href="tel:+9411269112"><i class="fas fa-phone"></i> +94 11269112</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>Inquiry via email</h4>
                        <ul>
                            <li><a style="text-transform: lowercase;" href="mailto:inquiry@tfms.lk" target="_blank"> <i class="fas fa-envelope"></i>inquiry@tfms.lk</a></li>
                            <li><a style="text-transform: lowercase;" href="mailto:reporttotfms@tfms.lk" target="_blank"> <i class="fas fa-envelope"></i>reporttotfms@tfms.lk</a></li>
                    ...
                    <div class="footer-col">
                        ...
                        <ul>
                            <li><a href="gov.php">Government Official Log in</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <img class="footer-logo" src="assets/img/tfmslogo.png" style="width: 200px; height: auto" >
                    </div>
                </div>
            </div>
        </footer>
